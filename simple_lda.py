...
list_of_dictionary_choices = ["none", "technology", "automotive"]
...
parser.add_argument('-d', '--dictionary', help='dictionary used', default='none', choices=list_of_dictionary_choices)
